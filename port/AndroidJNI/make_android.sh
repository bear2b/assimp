...
ANDROID_NDK_PATH=~/ndk/android-ndk-r20 #/usr/local/Caskroom/android-ndk/18/android-ndk-18
ANDROID_CMAKE_PATH=${ANDROID_NDK_PATH}/build/cmake/android.toolchain.cmake  
#cmakeontrib\android-cmake

#ANDROID_NDK=~/ndk/android-ndk-r20 #/usr/local/Caskroom/android-ndk/18/android-ndk-r18
